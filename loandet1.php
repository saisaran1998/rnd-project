...
<html lang="en">
  ...
  <body id="page-top">
	...
	<p>your request  has been considered and we will keep yo update through your mail</p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 ml-auto">
            <p class="lead">A personal loan is a type of loan that helps you to tide over a difficult situation when you need funds pronto. 
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <hr class="star-dark mb-5">
              <form name="sentMessage" id="contactForm" onsubmit="index1.html">
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label>Name</label>
                  <input class="form-control" id="name" type="text" placeholder="Name" required="required" data-validation-required-message="Please enter your name.">
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <hr class="star-dark mb-5">
              <img class="img-fluid mb-5" src="img/portfolio/p7.png" alt="">
